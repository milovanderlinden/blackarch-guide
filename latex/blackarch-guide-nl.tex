...
\hypersetup{
  pdftitle={BlackArch Linux, BlackArch Linux handboek},
  pdfsubject={BlackArch Linux, BlackArch Linux handboek},
...
\rhead{BlackArch Linux handboek}
...
\end{figure}
\vspace{0.5cm}
\Huge{\textbf{BlackArch Linux handboek}}\\
\vspace{1cm}
...
\section{Overzicht}
Dit handboek is opgedeeld in de volgende delen:
\begin{itemize}
\item Introductie - Biedt een overzicht, introductie en aanvullende project informatie
\item Gebruikershandleiding - Alles wat een doorsnee gebruiker dient te weten om BlackArch effectief te kunnen gebruiken
\item Ontwikkelaarshandleiding - Leer hoe je kunt meedoen en bijdragen aan BlackArch
\item Toepassingen - Uitleg over de verschillende toepassingen binnen BlackArch (WIP)
\end{itemize}

\section{Wat is BlackArch Linux?}
BlackArch is een complete Linux distributie voor pentesters en security specialisten.
Het is afgeleid van \href{https://www.archlinux.org/}{ArchLinux}. Je kunt BlackArch volledig installeren of specifieke toepassingen selecteren en los installeren.

Alle toepassingen die onderdeel zijn van BlackArch zijn beschikbaar als \href{https://wiki.archlinux.org/index.php/Unofficial\_User\_Repositories}
{niet officiele repository} voor ArchLinux. Op deze manier kan BlackArch aan een bestaande ArchLinux installatie worden toegevoegd. Ook hier geldt dat toepassingen (Packages) los of per categorie kunnen worden geinstalleerd.
